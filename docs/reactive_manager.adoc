...
Human interactions are complex. Operations and processes can be complex as well. The dynamic nature of the managerial environment highlights some assumptions:
...
* previous experience cannot be externally 'patterned' for future re-usage
