...
[#Responsiveness]
* xref:responsiveness{relfilesuffix}[Responsiveness] +
The manager should respond on time. + 
Always.

[#Elasticity]
* xref:elasticity{relfilesuffix}[Elasticity] +
The manager stays responsive under varying workloads.

[#Resilience]
* xref:resilience{relfilesuffix}[Resilience] +
The manager stays responsive in the face of failure.

[#Back_To]
<- xref:../reactive_manager{relfilesuffix}[Back to Reactive Manager]